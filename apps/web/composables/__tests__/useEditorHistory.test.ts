...
describe('useEditorHistory', () => {
  ...
  describe('undo', () => {
    ...
    it('should undo to previous state', async () => {
      ...
      const { history, historyIndex, undo } = useEditorHistory(
        content,
        editingBlockIndex,
        getTextarea
      );
  ...
  describe('redo', () => {
    it('should not redo when at end of history', async () => {
      ...
      const { history, historyIndex, redo } = useEditorHistory(
        content,
        editingBlockIndex,
        getTextarea
      );
  ...
  describe('undo/redo sequence', () => {
    it('should correctly navigate through history', async () => {
      ...
      const { history, historyIndex, undo, redo } = useEditorHistory(
        content,
        editingBlockIndex,
        getTextarea
      );
  ...
  describe('isUndoRedo flag', () => {
    it('should set isUndoRedo during undo operation', async () => {
      ...
      const { history, historyIndex, undo, isUndoRedo } = useEditorHistory(
        content,
        editingBlockIndex,
        getTextarea
      );
    ...
    it('should set isUndoRedo during redo operation', async () => {
      ...
      const { history, historyIndex, redo, isUndoRedo } = useEditorHistory(
        content,
        editingBlockIndex,
        getTextarea
      );
